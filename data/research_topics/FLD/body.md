...
この考えに基づき、私たちは**LLMが論理推論を学ぶための「論理推論問題」**を設計しました。
与えられた事実に対して、基礎的な推論規則を一歩ずつ適用し、最終的な答えに到達します。
AやBに対して様々な事実を当てはめた問題により、推論規則の一般性も学べます。
さらに、こうした問題を大量に作成するための**自動生成アルゴリズム**を開発しました。
